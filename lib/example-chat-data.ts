  ...
  return [
    {
      ...
      timestamp: new Date(Date.now() - 60000 * 6).toISOString(), // 6 minutes ago
    },
    {
    ...
    },
    {
      ...
      status: "success" as MessageStatus,
      timestamp: new Date(Date.now() - 60000 * 4).toISOString(), // 4 minutes ago
    },
    {
      role: "user" as MessageRole,
      content: "That sounds interesting. How much does it cost?",
      status: "success" as MessageStatus,
      timestamp: new Date(Date.now() - 60000 * 3).toISOString(), // 3 minutes ago
    },
    {
      role: "assistant" as MessageRole,
